...
private:
	Player * player;
	HUD * hud;
	PowerUp * powerUp;//power up variable
	std::string level; //string used for changing the json file used in levelloader 
...
public:
	...
	void createTowerBases();    //method used to create taxis
	...
	void activatePauseScene(Ref *pSender);//changes to the pause scene
	void update(float dt);
	void activateGameOverScene(float dt);//changes to the game over scene
